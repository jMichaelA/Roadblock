...
MYGAME.menus['HighScoresMenuState'] = (function (graphics, input, gameStack) {

    function Menu() {
        var that = {
            dead: false
        },
            hsText = graphics.Text({
                font: '36px Arial',
                align: 'center',
            ...
            backText = graphics.Text({
                ...
                baseLine: 'middle',
                x: graphics.canvas.width / 2,
                y: (graphics.canvas.height / 3) + ((graphics.canvas.height / 3) / 2) * 3.5
            }),
            tWidth = 0,
            tHeight = 0,
            tPos = {},
        ...
        that.update = function (elapsedTime) {
            ...
            hsText.setPos(canvas.width / 2, (graphics.canvas.height / 8));
            backText.setPos(canvas.width / 2, (graphics.canvas.height / 3) + ((graphics.canvas.height / 3) / 2) * 3.5);
