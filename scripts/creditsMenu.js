MYGAME.menus['CreditsMenuState'] = (function (graphics, input, gameStack) {

    function Menu() {
        var that = {
            dead: false
        },
            credText = graphics.Text({
                font: '32px Arial',
                align: 'center',
        ...
        that.update = function (elapsedTime) {
            ...
            credText.setPos(canvas.width / 2, (graphics.canvas.height / 3));
            credText2.setPos(canvas.width / 2, (graphics.canvas.height / 3) + ((graphics.canvas.height / 3) / 4));
